...
public final class viewReturnProduct_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <h1 class=\"h3 mb-0 text-gray-800\">Returned Product : </h1>\n");
      ...
      out.write("                <th>Seller's Details</th>\n");
      out.write("                \n");
      out.write("            </tr>\n");
      out.write("         ");
      ...
      out.print(rp.getId());
      out.write("</td>\n");
      out.write("             <td><a href=\"orderDetail.jsp?order_id=");
      out.print(rp.getId());
      out.write("\">Order Details</a></td>\n");
      out.write("             <td>");
      out.print(pd.getById(rp.getProduct_id()).getName() );
      out.write("</td> \n");
      out.write("             <td>");
      out.print(rp.getQuantity());
      out.write("</td>\n");
      out.write("             <td>");
      out.print(rp.getDate() );
      out.write("</td>\n");
      out.write("             <td>");
      out.print(new CustomerDao().getById(rp.getCustomer_id()).getName() );
      out.write("</td>\n");
      out.write("             <td>");
      ...
      out.write(")</td>\n");
      out.write("             <td>");
      out.print(rp.getStatus());
      out.write("</td>\n");
      out.write("             <td>");
Shopkeeper sk = sd.getByProductId(rp.getProduct_id());
      out.write("\n");
      out.write("                 ");
      out.print(sk.getShopName());
      out.write(" <br/> ");
      out.print(sk.getAddress());
      out.write(",PIN:(");
      out.print(sk.getPin());
      out.write(")<br/> Contact :");
      out.print(sk.getContact());
      out.write("\n");
      out.write("             </td>\n");
      out.write("                 </tr>\n");
      out.write("         ");
