                    ...
                    <jsp:include page="topbar.jsp"></jsp:include>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="col col-md-12">
                                ...
                                <form class="form">
                                    <center><h3>List of Approved Product</h3></center>
                                    ...
                                    <%
                                        ...
                                        ArrayList<Product> products = pd.getAllProductByShopkeeperIdAndStatus(shopkeeper.getId(),"approved");
                                        WeartypeDao wd = new WeartypeDao();
                                        CategoryDao cd = new CategoryDao();
                                       if(products.size()==0)
                                           out.println("<tr><th colspan='9'> <h2>No approved products</h2>");
