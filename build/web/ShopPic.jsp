        ...
        <div class="container">
            <div class="row">
                <div class="col col-md-6">
                    <center>
               <form action="ShopkeeperController?op=add" method="post" enctype="multipart/form-data" class="form">
                   ...
                   <br/>
                   <a href="shopkeeperRegistration.jsp" class="btn btn-success" > Check previous data</a>
