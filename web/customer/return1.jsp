    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <jsp:include page="topbar.jsp"></jsp:include>
        ...
        <div class="container-fluid">
            ...
            <h1 class="h3 mb-0 text-gray-800">You can Return Only the Delivered products <br/> Within 15 Days : </h1>
        ...
        <table width='700' border='1' cellspacing='0' class="table table-striped">
         ...
         <tr>
             ...
             <td><%=od.getCurrentStatus(order.getId())%></td>
              <td><%=od.getDeliveryDate(order.getId())%></td>
              <td><%if(od.getCurrentStatus(order.getId()).equalsIgnoreCase("Delivered")) { %><a href="return2.jsp?order_id=<%=order.getId()%>">View and Return </a><%}%></td>
         </tr>
         <% } %>
    </table>
    <br/>
